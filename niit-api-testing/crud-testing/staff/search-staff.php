...
$searchUserQuery = mysqli_query($conn, "SELECT staff_tab.*, status_tab.status_name FROM staff_tab, status_tab WHERE staff_tab.status_id = status_tab.status_id AND (staff_tab.first_name LIKE '%$searchContent%' OR staff_tab.last_name LIKE '%$searchContent%' OR staff_tab.email_address LIKE '%$searchContent%' OR staff_tab.staff_id LIKE '%$searchContent%')") or die(mysqli_error($conn));
