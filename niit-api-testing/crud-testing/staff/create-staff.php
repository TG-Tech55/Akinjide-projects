...
mysqli_query($conn, "INSERT INTO `staff_tab`
    ( `staff_id`, `first_name`, `last_name`, `email_address`, `phone`, `status_id`, `password`, `role_id`, `created_at`, `updated_at`) VALUES
    ('$staffId', '$firstName', '$lastName', '$emailAddress', '$phone', '$statusId', '$hashPassword', '$roleId', NOW(), NOW())") or die(mysqli_error($conn));
